...
import apple.uikit.UIKeyModifierFlags;
...
public class IosControllerManager extends AbstractControllerManager {
    ...
    private void handleKeyPressed(UIKeyCommand sender) {
        if (iCadeController == null) {
            ...
            synchronized (listeners) {
                for (ControllerListener listener : listeners) listener.connected(iCadeController);
            }
        }
    ...
    protected void onControllerConnect(GCController gcController) {
        ...
        if (!alreadyInList) {
            ...
            synchronized (listeners) {
                for (ControllerListener listener : listeners) listener.connected(iosController);
            }
        }
    }
    ...
    protected void onControllerDisconnect(GCController gcController) {
        ...
        if (oldReference != null) {
            ...
            synchronized (listeners) {
                for (ControllerListener listener : listeners) listener.disconnected(oldReference);
            }
